 ...
 * @author natade (https://github.com/natade-jp)
 * @license MIT
 */class s{constructor(t,e,i){this.width=1,this.height=1,arguments.length>=2&&(this.width=e,this.height=i),3==arguments.length?this.setPixelWrapMode(t):this.setPixelWrapMode(s.MODE.INSIDE)}clone(){return new s(this.wrapmode,this.width,this.height)}setPixelWrapMode(t){this.wrapmode=t,t===s.MODE.INSIDE?this.wrap=new r(this.width,this.height):t===s.MODE.CLAMP?this.wrap=new n(this.width,this.height):t===s.MODE.REPEAT&&(this.wrap=new h(this.width,this.height))}setSize(t,e){this.width=t,this.height=e,this.wrap&&this.wrap.setSize(t,e)}getPixelPosition(t,e){return this.wrap.getPixelPosition(t,e)}}s.MODE={INSIDE:"INSIDE",CLAMP:"CLAMP",REPEAT:"REPEAT"};
/**
 * 補間モード・関数群をまとめたクラス
 ...
 * @license MIT
 */
const w={DataRGBA:f,ColorRGBA:c,DataY:p,ColorY:g,FIRMatrix:a,MODE_WRAP:u.MODE_WRAP,MODE_IP:u.MODE_IP,MODE_BLEND:u.MODE_BLEND};export{w as default};
